export class Statistics {
  constructor(
    ...
    // time position
    this.timeLeft = Math.round(this.x * 0.15);
    this.timeRight = Math.round(this.x * 0.25);
    // score position
    this.scoreLeft = Math.round(this.x * 0.45);
    this.scoreRight = Math.round(this.x * 0.5);
    //chances position
    this.chanceLeft = Math.round(this.x * 0.8);
    this.chanceRight = Math.round(this.x * 0.9);
